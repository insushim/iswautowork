...
export const ACHIEVEMENT_STANDARDS: AchievementStandard[] = [
  ...
  { code: '[6도03-01]', content: '인권의 의미와 인권을 존중하는 삶의 중요성을 이해하고, 인권 존중의 방법을 익혀 이를 실천할 수 있다.', grade: 6, semester: 1, subject: '도덕', domain: '사회·공동체와의 관계' },
  { code: '[6도03-02]', content: '공정의 의미와 공정한 사회의 필요성을 이해하고, 일상생활에서 공정하게 생활하려는 실천 의지를 기를 수 있다.', grade: 6, semester: 1, subject: '도덕', domain: '사회·공동체와의 관계' },
  { code: '[6도03-03]', content: '나라를 사랑하는 마음의 중요성을 깨닫고, 통일 한국을 실현하기 위한 적극적인 통일 의지와 태도를 기를 수 있다.', grade: 6, semester: 1, subject: '도덕', domain: '사회·공동체와의 관계' },
