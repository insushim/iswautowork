...
function getStarterExamples(subjectName: string): string {
  const starters: Record<string, string> = {
    ...
    '사회': '"조사 활동을 통해~", "지도 읽기 활동에서~", "탐구 활동에서~", "토론 수업에서~", "자료 분석을 통해~", "현장 학습에서~"',
    ...
    '슬기로운생활': '"관찰 활동에서~", "탐구 활동을 통해~", "조사 활동에서~", "분류 활동을 통해~", "현장 학습에서~"',
...
function getActivityExamples(subjectName: string): string {
  const activities: Record<string, string> = {
    ...
    '사회': '조사 활동, 지도 읽기, 사회 탐구, 사회 현상 분석, 토론, 역할극, 현장 학습, 자료 분석, 인터뷰, 프로젝트, 신문 만들기, 시사 토론, 지역 사회 탐방',
