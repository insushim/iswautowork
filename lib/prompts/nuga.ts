...
2. **수학 기호 사용 금지**: ×, ÷, +, -, =, % 등 수학 기호를 사용하지 말고 문장으로 작성 (예: ×→곱하기, ÷→나누기, %→퍼센트)
3. **연결어 자제**: "특히", "또한", "그리고" 등은 문장 시작에 사용 금지
4. **부정적 표현 금지**: 비판, 비교, 부정적 언급 절대 불가
5. **초등학생 수준 유지**: 논문, 학술자료 등 부적절한 활동 언급 금지
