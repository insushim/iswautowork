...
8. **초등학생 수준**: 초등학생이 실제로 할 수 있는 활동만 작성하세요. "논문 읽기", "학술 자료 분석", "전문 서적 탐독" 등 초등학생에게 부적절한 활동은 절대 사용하지 마세요.
9. **첫 문장 영역 다양화 필수!** 모든 학생이 같은 영역(예: 학교생활)으로 시작하면 안 됩니다. 1번은 학교생활, 2번은 학습태도, 3번은 교우관계, 4번은 인성, 5번은 특기 등 첫 문장에서 다루는 영역을 반드시 다르게 하세요.
10. **작성 순서 다양화!** 같은 영역을 다루더라도 학생마다 영역 배치 순서를 다르게 하세요. 예: 1번 "학교생활→학습→교우", 2번 "인성→특기→학교생활"
